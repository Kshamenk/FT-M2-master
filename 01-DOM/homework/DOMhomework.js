...
// Tu código acá:
//var nombre= 'Martin Juncos' 
var createBy= document.querySelector('#createdBy');
createBy.innerHTML= createBy.innerHTML + ' Martin Juncos';
...
function buildToDo(todo, index) {
  ...
  const toDoText= document.createElement('spam')
...
function buildToDos(toDos) {
  ...
  var arr = toDos.map((e, i)=> buildToDo(e, i))
  return arr
}
...
function displayToDos() {
  ...
  const res = buildToDos(toDoItems)
